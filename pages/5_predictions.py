...
if best_model_name == "Random Forest":
    explanation = (
        ...
        "requires no feature scaling, naturally handles class imbalance, "
        "and gives interpretable feature importances."
    )
else:
    explanation = (
...
# Subteam filter
subteams = ["All"] + sorted(
    [s for s in predictions_df["Subteam"].dropna().unique() if str(s) not in ("", "None")]
)
